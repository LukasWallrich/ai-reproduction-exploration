...
# #   )
#
# # Display with color-coded categories
# deviations %>%
...
#       deviations$category == "Exact" ~ "#d4edda",
#       deviations$category == "Minor deviation" ~ "#fff3cd",
#       deviations$category == "Substantive deviation" ~ "#f8d7da",
#       deviations$category == "Conclusion change" ~ "#f5c6cb",
#       TRUE ~ "#ffffff"
#     )
#   )
```
